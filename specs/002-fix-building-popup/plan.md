...
`/home/mainuser/Desktop/MATreeCover/specs/002-fix-building-popup/spec.md`
**Source truth**: committed spec (`spec.md`) authoritative. The
unfilled `.specify/memory/constitution.md` template carries no
...
No `.specify/memory/constitution.md` file exists in this workspace
...
`tasks.md` is the Phase 2 output, generated by `/speckit.tasks`, not
created here.
